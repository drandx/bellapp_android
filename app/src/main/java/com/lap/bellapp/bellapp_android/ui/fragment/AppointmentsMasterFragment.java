...
import com.lap.bellapp.bellapp_android.ui.external.SlidingTabLayout;
...
public class AppointmentsMasterFragment extends BaseFragment {
    ...
    public static AppointmentsMasterFragment newInstance(int userId) {
    ...
    /**
     * Internal class that extends the {@link FragmentPagerAdapter}
     *
    ...
    class MainPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            AppointmentsListFragment fragment = AppointmentsListFragment.newInstance(position, userId);
            return fragment;
        }
